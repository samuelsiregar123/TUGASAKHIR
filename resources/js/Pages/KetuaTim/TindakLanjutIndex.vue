...
<template>
    <SidebarLayout title="Tindak Lanjut">
        ...
        <p class="page-sub">Daftar audit dan progress tindak lanjut temuan</p>
            ...
            <table class="data-table">
                <thead>
                    <tr>
                        ...
                        <th style="width:20%; text-align:center">Total Temuan</th>
                        <th style="width:18%; text-align:center">Proses</th>
                    ...
                    <tr v-for="(plan, i) in filtered" :key="plan.id">
                        ...
                        <td style="text-align:center">
                            <button v-if="plan.total_temuan > 0" class="btn-link"
                                @click="router.visit(`/ketua-tim/tindak-lanjut/${plan.id}`)">Buka</button>
...
.search-input { flex:1; min-width:200px; height:32px; border:1px solid #ddd; border-radius:6px; padding:0 10px; font-size:.8rem; }
